 ...
 *
 * map_blocks et la palette sont repris tels quels de l'ancien main.h
 * (verifies identiques octet pour octet a un binaire xrick de reference).
 * map_bnums a ete regenere a partir des donnees stock extraites d'un
 * binaire xrick (symbole ELF map_bnums) : c'est la carte d'origine du
 * jeu, sans aucune modification manuelle.
 * tiles_data (donnees graphiques des tuiles) vit desormais uniquement
 * dans dat_tilesST.c (cf. tiles.h) -- plus de copie dupliquee ici.
 */
